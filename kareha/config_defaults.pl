...
BEGIN {
	...
	eval "use constant RES_DIR => 'data/res/'" unless(defined &RES_DIR);
	eval "use constant CSS_DIR => 'data/css/'" unless(defined &CSS_DIR);
	eval "use constant IMG_DIR => 'data/src/'" unless(defined &IMG_DIR);
	eval "use constant THUMB_DIR => 'data/thumb/'" unless(defined &THUMB_DIR);
	eval "use constant INCLUDE_DIR => 'data/include/'" unless(defined &INCLUDE_DIR);
	eval "use constant LOG_FILE => 'data/log.txt'" unless(defined &LOG_FILE);
	...
	eval "use constant JS_FILE => 'data/kareha.js'" unless(defined &JS_FILE);
